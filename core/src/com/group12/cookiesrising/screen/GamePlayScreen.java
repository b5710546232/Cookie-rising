...
//            Gdx.app.log(TAG,"touch x = "+inputs.x+"  ||  "+"touch y = "+inputs.y);
    ...
    private void initButton(){
        ...
        ImageButton hero3Button = new ImageButton(Assets.button_sheet_drawable.get(4),Assets.button_sheet_drawable.get(5));
        hero3Button.addListener(hero3Lis.getListener());
        hero3Button.setPosition(40,10);
        stage.addActor(hero3Button);
        ImageButton hero2Button = new ImageButton(Assets.button_sheet_drawable.get(2),Assets.button_sheet_drawable.get(3));
        hero2Button.addListener(hero2Lis.getListener());
        hero2Button.setPosition(130,10);
        stage.addActor(hero2Button);
        ImageButton hero1Button = new ImageButton(Assets.button_sheet_drawable.get(0),Assets.button_sheet_drawable.get(1));
        hero1Button.addListener(hero1Lis.getListener());
        hero1Button.setPosition(220,10);
        stage.addActor(hero1Button);

        ImageButton atkButton = new ImageButton(Assets.button_sheet_drawable.get(8),Assets.button_sheet_drawable.get(9));
        atkButton.addListener(atkLis.getListener());
        atkButton.setPosition(340,10);
        stage.addActor(atkButton);
        ImageButton healButton = new ImageButton(Assets.button_sheet_drawable.get(10),Assets.button_sheet_drawable.get(11));
        healButton.addListener(healLis.getListener());
        healButton.setPosition(430,10);
        stage.addActor(healButton);
        ImageButton criButton = new ImageButton(Assets.button_sheet_drawable.get(6),Assets.button_sheet_drawable.get(7));
